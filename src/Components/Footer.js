    ...
    <div className="footer-section">
      <div className="footer-container">
        <div className="ft-info">
          <div className="ft-info-p1">
            <p className="ft-title">
              MindEase <span className="ft-sign"></span>
            </p>
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@healthplus.com">Mind_Ease@gmail.com</a>
            </li>
            <li>
            ...
            <li>
              <a href="tel:+022 5454 5252">+91 8799992023</a>
            </li>
            <li>
              <a href="tel:+022 2326 6232">+91 8788787887</a>
            </li>
          </ul>
        </div>
      </div>
